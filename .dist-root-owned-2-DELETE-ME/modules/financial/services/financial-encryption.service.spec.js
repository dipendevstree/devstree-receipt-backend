...
class TestKeyProvider {
    keys = new Map([
        [1, (0, crypto_1.randomBytes)(32)],
        [2, (0, crypto_1.randomBytes)(32)],
    ]);
    current = 1;
...
describe('FinancialEncryptionService', () => {
    ...
    it('rejects malformed encryption metadata', () => {
        expect(() => service.decryptAmount({
            encryptedAmount: 'x',
            amountIv: 'short',
            amountAuthTag: 'short',
            encryptionKeyVersion: 1,
        }, financial_encryption_service_1.EncryptionContext.PAYMENT_AMOUNT)).toThrow();
    });
