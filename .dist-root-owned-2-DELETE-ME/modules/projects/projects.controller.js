...
let ProjectsController = class ProjectsController {
    ...
    create(dto, user, context, access) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Backs every project dropdown in the UI. Filtering happens in Postgres so the browser never loads the full project table.',
    }),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [project_dto_1.ProjectLookupQueryDto]),
    __metadata("design:returntype", Promise)
], ProjectsController.prototype, "lookup", null);
__decorate([
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'The project amount is optional and, when supplied, is encrypted before storage. Projects created without one accept payments of any valid amount.',
    }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __param(2, (0, request_context_decorator_1.ReqContext)()),
    __param(3, (0, financial_unlock_decorator_1.FinancialAccess)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [project_dto_1.CreateProjectDto, Object, Object, Object]),
    __metadata("design:returntype", Promise)
