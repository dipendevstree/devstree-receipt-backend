...
exports.ClientLookupDto = exports.ClientLookupQueryDto = exports.ClientResponseDto = exports.QueryClientDto = exports.UpdateClientDto = exports.CreateClientDto = void 0;
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Administrator who created this client' }),
    __metadata("design:type", Object)
], ClientResponseDto.prototype, "createdByName", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Administrator who last updated this client' }),
    __metadata("design:type", Object)
], ClientResponseDto.prototype, "updatedByName", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", Number)
], ClientResponseDto.prototype, "projectCount", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Projects with a defined project amount' }),
    __metadata("design:type", Number)
], ClientResponseDto.prototype, "fixedProjectCount", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Projects with no defined amount (monthly/retainer style)' }),
    __metadata("design:type", Number)
], ClientResponseDto.prototype, "variableProjectCount", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Object)
], ClientResponseDto.prototype, "variableReceived", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        example: '400000.00',
        nullable: true,
        description: 'Outstanding on fixed-amount projects only. Variable projects are never counted as due.',
    }),
    __metadata("design:type", Object)
...
class ClientLookupQueryDto {
    search;
    limit;
    includeInactive;
}
exports.ClientLookupQueryDto = ClientLookupQueryDto;
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Free-text search across name, company, code and email' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MaxLength)(120),
    (0, class_transformer_1.Transform)(({ value }) => (typeof value === 'string' ? value.trim() : value)),
    __metadata("design:type", String)
], ClientLookupQueryDto.prototype, "search", void 0);
__decorate([
    ...
    __metadata("design:type", Number)
], ClientLookupQueryDto.prototype, "limit", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        default: false,
    ...
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Transform)(({ value }) => value === undefined || value === '' ? false : ['true', '1', 'yes', true].includes(value)),
    __metadata("design:type", Boolean)
], ClientLookupQueryDto.prototype, "includeInactive", void 0);
class ClientLookupDto {
    id;
    name;
    companyName;
    clientCode;
...
exports.ClientLookupDto = ClientLookupDto;
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", String)
], ClientLookupDto.prototype, "id", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", String)
], ClientLookupDto.prototype, "name", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)(),
    __metadata("design:type", Object)
], ClientLookupDto.prototype, "companyName", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", String)
], ClientLookupDto.prototype, "clientCode", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ enum: client_status_enum_1.ClientStatus }),
    __metadata("design:type", String)
], ClientLookupDto.prototype, "status", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Set on the last row when more results exist' }),
    __metadata("design:type", Boolean)
], ClientLookupDto.prototype, "hasMore", void 0);
