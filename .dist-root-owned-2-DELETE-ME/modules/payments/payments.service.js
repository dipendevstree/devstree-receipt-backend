...
let PaymentsService = class PaymentsService {
    ...
    async findAll(query, unlocked) {
        ...
        builder.orderBy((0, pagination_dto_1.resolveSortColumn)(query.sortBy, SORTABLE, 'createdAt'), query.sortOrder);
        ...
        if (!amountFilter) {
            ...
            return pagination_dto_1.PaginatedResult.of(payments.map((payment) => this.toResponse(payment, unlocked)), total, query.page, query.limit);
        }
        ...
        return pagination_dto_1.PaginatedResult.of(page.map((payment) => this.toResponse(payment, unlocked)), matching.length, query.page, query.limit);
    }
    ...
    toResponse(payment, unlocked) {
        ...
        const projectAmount = hasProjectAmount && unlocked && project
        ...
        return {
            ...
            hasProjectAmount,
            projectAmount: (0, mask_util_1.maskAmount)(projectAmount, unlocked),
            paymentDate: payment.paymentDate,
            paymentMethod: payment.paymentMethod,
            transactionReference: payment.transactionReference,
