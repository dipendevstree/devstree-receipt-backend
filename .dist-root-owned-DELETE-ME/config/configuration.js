...
exports.default = () => ({
    ...
    seed: {
        ...
        adminEmail: process.env.SEED_ADMIN_EMAIL ?? 'admin@devstree.local',
        adminPhone: process.env.SEED_ADMIN_PHONE ?? '9000000001',
        adminPassword: process.env.SEED_ADMIN_PASSWORD,
        adminAccountPassword: process.env.SEED_ADMIN_ACCOUNT_PASSWORD,
    },
});
