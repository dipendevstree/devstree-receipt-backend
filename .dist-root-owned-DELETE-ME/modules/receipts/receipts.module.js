...
exports.ReceiptsModule = ReceiptsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([receipt_entity_1.Receipt]), audit_logs_module_1.AuditLogsModule, settings_module_1.SettingsModule],
        controllers: [receipts_controller_1.ReceiptsController],
        providers: [receipts_service_1.ReceiptsService, receipt_pdf_service_1.ReceiptPdfService],
